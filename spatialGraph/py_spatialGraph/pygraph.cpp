...
PYBIND11_MODULE(pygraph, m)
{
  ...
  m.def("delaunay_graph", &py_delaunay, "Input: 2d-numpy array containing n points in R^2. Output: array E of edges, where E[i] and E[i+1] forall i are point indices represents an undirected edge of the delaunay graph.");

  m.def("gabriel_graph", &py_gabriel, "Input: 2d-numpy array containing n points in R^2. Output: array E of size n*2, where E[i] and E[i+1] forall i are point indices represents an undirected edge of the Gabriel graph.");
}
