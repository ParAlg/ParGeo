...
template<class hullT, class facetT, class pointT>
hullT* pargeo::hull3d::initSerial(parlay::slice<pointT*, pointT*> PIn) {
...
template<class hullT, class facetT, class pointT>
hullT* pargeo::hull3d::initParallel(parlay::slice<pointT*, pointT*> PIn) {
  using vertexT = vertex<facetT, pointT>;
  using floatT = typename vertexT::floatT;
