...
//#include "dynamicKdTree/cache-oblivious/cokdtree.h"
#include "dynamicKdTree/binary-heap-layout/bhlkdtree.h"
//#include "dynamicKdTree/log-tree/logtree.h"
...
template <int dim, class Tree>
void dispatchTest(parlay::sequence<pargeo::point<dim>>& P, const TestOptions& test_options) {
  // std::cout << "[";
...
void timeTrees(parlay::sequence<pargeo::point<dim>>& P, const TestOptions& test_options) {
  // typedef CO_KdTree<dim, pargeo::point<dim>, parallel, coarsen> COTree_t;// TODO
  typedef BHL_KdTree<dim, pargeo::point<dim>, parallel, coarsen> BHLTree_t;
  constexpr int NUM_TREES = 21;
  constexpr int BUFFER_LOG2_SIZE = 7;
  // typedef LogTree<NUM_TREES, BUFFER_LOG2_SIZE, dim, pargeo::point<dim>, parallel, coarsen> LogTree_t;
...
inline void runTests(const char* iFile, const TestOptions& test_options) {
  parlay::sequence<pargeo::point<dim>> Points =
    pargeo::pointIO::readPointsFromFile<pargeo::point<dim>>(iFile);
