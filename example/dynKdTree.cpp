...
template<int dim>
void timeKnn(parlay::sequence<pargeo::point<dim>> &P,
	     size_t k, int batches, char const *outFile) {
...
int main(int argc, char* argv[]) {
  ...
  size_t batches = P.getOptionIntValue("-b",1);
