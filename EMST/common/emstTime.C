...
template<int dim>
void timeEmst(point<dim>* pts, intT n, int rounds, char* outFile, int perturb) {
  cout << "nmax = " << n << endl;
  if (perturb) {
